...
-- (19 rows)
        ...
        FROM city 
        WHERE district IN ('West Virginia', 'Pennsylvania', 'Kentucky', 'Indiana', 'Michigan')
...
-- (highest life expectancies in world: 83.5, 166.6666, "Andorra")
        ...
        SELECT name, (population/surfacearea) as populationdensity, lifeexpectancy
        FROM country
...
-- (smallest difference: 1.00, 1.00, "Ecuador")
        ...
        SELECT (gnp-gnpold) AS difference, ABS(gnp-gnpold) AS absolutedifference, name 
        FROM country
