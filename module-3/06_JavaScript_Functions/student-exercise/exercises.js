...
function useParameterToFilterArray(filterFunction) {
    return constFilterArray = unfilteredArray.filter(filterFunction); 
}
 ...
 */
 ...
 function getFullAddressesOfProperties(properties) {
     let result = 
     properties.map(({streetNumber, streetName, streetType, city, state, zip}) => 
     (`${streetNumber} ${streetName} ${streetType} ${city} ${state} ${zip}`));
     return result;
 }
