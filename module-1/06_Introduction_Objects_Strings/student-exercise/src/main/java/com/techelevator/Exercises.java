...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		...
		String lastOut = out.substring(out.length() - 2);
	...
	public String middleTwo(String str) {
		...
		return str.substring(str1 - 1, str1 + 1);
	}
	...
	public String twoChar(String str, int index) {
		if (str.length() <= index || index + 2 > str.length() || index < 0) {
			return str.substring(0, 2);
		}
		else {
	...
	public String middleThree(String str) {
		...
		return str.substring(str2 - 1, str2 + 2);
	}
	...
	/*
	 ...
	 doubleX("xxxxx") → true index of
	 */
	public boolean doubleX(String str) {
		
	
			if (str.contains("xx")&&(str.indexOf("x") == str.indexOf("xx"))) {
				return true;
			}
			return false;
		}
	...
	public String stringSplosion(String str) {
		...
		for(int i = 0; i < str.length(); i++) {
			splode = splode + str.substring(0, i+1);
		}
		return splode;
	}
	...
	/*
	 ...
	 stringYak("yak123ya") → "123ya" //use contains method 
	 */
	public String stringYak(String str) {
		boolean hadYak = str.contains("yak");
		
			String yaketyYak = str.replaceAll("yak", "");
